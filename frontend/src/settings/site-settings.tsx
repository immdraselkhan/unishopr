...
export const siteSettings = {
	name: "Unishopr",
	description:
		"UniShopr is the overseas online shopping platform to get items from anywhere of the world. The mission is simple “Connecting the world”. We do connect shoppers and travelers over the world to bring items from different corners.",
	author: {
		name: "Unishopr",
		websiteUrl: "https://unishopr.com",
		address: "",
	},
	logo: {
